  ...
  return (
    <div className={twMerge(styles.field, className)}>
      <input
        ...
        placeholder=" "
        {...inputProps}
        className="border-night-400 bg-night-700 text-body-xs focus:border-accent-purple disabled:bg-night-400 h-16 w-full rounded-lg border px-4 pt-4 caret-white outline-none"
      />
  ...
  return (
    <div className={twMerge(styles.textareaField, className)}>
      <textarea
        ...
        placeholder=" "
        {...textareaProps}
        className="border-night-400 bg-night-700 text-body-xs focus:border-accent-purple disabled:bg-night-400 h-48 w-full rounded-lg border px-4 pt-8 caret-white outline-none"
      />
      {/* the label comes after the input so we can use the sibling selector in the CSS to give us animated label control in CSS only */}
      <label htmlFor={id} {...labelProps} />
      <div className="px-4 pt-1 pb-3">
...
//   const className = twMerge(baseClassName, {
